...
**Researcher in deepfake detection & image forensics** at **Beijing Jiaotong University**.
...
| **[AeroTower](https://github.com/LuKun-Zhang/AeroTower)** | Civil-aviation route-dispatch simulation application (course project). |
